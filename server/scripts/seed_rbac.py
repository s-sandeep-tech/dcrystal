...
def seed_rbac():
    ...
    with app.app_context():
        ...
        app_menus = [
            ...
            {"title": "Party Design Location Allocation", "url": "/party-design-location-allocation", "icon": "pin_drop", "order": 71.8},
            {"title": "Party Order Cancellation Performance", "url": "/party-order-cancellation-performance", "icon": "cancel", "order": 71.9},
            ...
            {"title": "Make Wise Design Allocation Info", "url": "/design-allocation-performance", "icon": "category", "order": 71.999},
