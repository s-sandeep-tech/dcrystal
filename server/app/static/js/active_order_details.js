let currentZoom = parseFloat(localStorage.getItem('activedetails-zoom')) || 1.0;
let makeMultiSelect;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    makeMultiSelect = new CustomMultiSelect({
        ...
        options: window.activeOrderDetailsAvailableMakes || []
    });
...
function adjustZoom(delta, reset = false) {
    ...
    localStorage.setItem('activedetails-zoom', currentZoom);
