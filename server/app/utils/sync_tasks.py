        ...
        query = """
         WITH
            qc_agg AS (
                ...
                CASE
                    WHEN BOOL_OR(qc_status_name = 'Passed') THEN 'Passed'
                    WHEN BOOL_OR(qc_status_name <> 'Passed') THEN 'Rejected'
                    ELSE 'Not Passed'
                END AS qc_status
            ...
            status_rows AS (
                ...
                UNION ALL
                SELECT order_id, party_name, 'QC Completed', qc_date
                FROM base
                ...
                FROM base
                WHERE qc_rejected_date IS NOT NULL
                    AND qc_status = 'Rejected'
