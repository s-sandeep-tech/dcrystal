...
def showroom_wise_order_summary():
    try:
        ...
        cache_key = generate_cache_key('showroom_main', latest_date_query, 
                                     ...
                                     order_request_type=order_request_type, provision_type=provision_type,
                                     branch_provision_type=branch_provision_type,
                                     division=division, group_name=group_name, purity=purity,
                                     classification=classification, make=make, collection=collection,
        ...
        main_q = apply_main_filters(main_q)
